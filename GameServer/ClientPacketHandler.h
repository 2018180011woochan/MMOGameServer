...
public:
	static void Init()
	{
		...
		GPacketHandler[PKT_C_ENTER_GAME] = [](PacketSessionRef& session, BYTE* buffer, int32 len) { return HandlePacket<C_ENTER_GAME>(Handle_C_ENTER_GAME, session, buffer, len); };
